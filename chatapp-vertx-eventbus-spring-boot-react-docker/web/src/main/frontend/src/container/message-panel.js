  ...
  //  console.log('MESSAGE_PANEL: Message Map:', this.props.messageMap);
    return(
      <div className="col-sm-8 conversation">
        ...
        <MessageList />
        <MessageConsole activeChatRoom={this.props.activeChatRoom} />
      </div>
    )
  }
}

function mapStateToProps({chatRoomList, messageMap, activeChatRoom}){// picking weather as state.weather
  return {chatRoomList, messageMap, activeChatRoom}//  {weather} is same as {weather:weather}
}
